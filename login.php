...
<head>
	...
	<?php
    $con = new mysqli('localhost','madhavspark','sparkmadhav','bank');
...
<h1 class="alert alert-success rounded-0"><?php echo bankname; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Madhav Kindra</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
